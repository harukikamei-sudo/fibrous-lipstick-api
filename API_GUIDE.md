  ...
  "results": [
    {
      ...
      "pc_score": 0.0,                    // PC Lab領域からの距離(0=領域内)
...
|---|---|---|---|---|
| pale_pink | 0.90 | 0.40 | 1.00 | 0.80 |
| healthy_pink | 0.80 | 0.50 | 1.00 | 0.80 |
| reddish | 0.80 | 0.50 | 0.90 | 0.80 |
| beige | 0.70 | 0.40 | 1.00 | 0.80 |
| dark | 0.70 | 0.50 | 0.90 | 0.80 |
| **全平均** | | | | **0.750 (good)** |

**イエベ秋だけ poor 寄り**(春の Lab 領域と被るため)。改善余地。
